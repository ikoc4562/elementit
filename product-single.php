                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="images/<?=$causes[0][4]?>" alt="First slide">
                                </div>
                                <?php
                                $sql = $db->prepare('select * from relImage where is_deleted=0 and relid=:id');
                                $sql->execute([
                                    'id'=>$_GET['id'],
                                ]);
                                $images = $sql->fetchAll();
                                ...
                                <div class="carousel-item <?php if($i==1){echo 'active';} ?>">
                                    <img class="d-block w-100" src="images/<?=$image[2]?>" alt="First slide">
                                </div>
                                    <?php
                                }
                                ?>
