...
<head>
  ...
  <title>Hallintapaneeli | Log in</title>
...
if (@$_POST['islogin'])
{
    ...
    {
        $mesaj='Väärä käyttäjätunnus tai salasana!';
    }
}
...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>Hallinta</b>paneeli</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Kirjaudu sisään aloittaaksesi istunnon</p>
    ...
    <form method="post" id="login-form">
      ...
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Sähköposti" name="kullaniciadi">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Salasana" name="sifre">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          <button type="submit" cclass="g-recaptcha"
                  data-sitekey="6LeG3N0ZAAAAAC7JH0vTwO0s5gqWia_TPtLbGc3L" data-callback='onSubmit'>Kirjaudu sisään</button>
        </div>
        <!-- /.col -->
