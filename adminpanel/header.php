...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-mini"><b>R.E.L</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">R.E.L Elementit</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">Sinulla <?=$say?> viestia</li>
                            <li>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    <small>Järjestelmänvalvoja</small>
                                </p>
                            </li>

                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="profil.php?id=<?=$_SESSION['id']?>" class="btn btn-default btn-flat">Profiili</a>
                                </div>
                                <div class="pull-right">
                                    <a href="logout.php?token=<?= $_SESSION['user_token'] ?>&id=<?=$_SESSION['id']?>" class="btn btn-default btn-flat">Kirjaudu ulos</a>
                                </div>
                            </li>
                        </ul>
                    </li>
